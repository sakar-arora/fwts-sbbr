...
static int sbbr_acpi_namespace_check_test1(fwts_framework *fw)
{
	int error_count = 0;
...
static int sbbr_acpi_table_check_test2(fwts_framework *fw)
{
	int i;
	bool checked = false;
...
static fwts_framework_minor_test sbbr_acpi_table_check_tests[] = {
	{ sbbr_acpi_namespace_check_test1, "Test that processors only exist in the _SB namespace." },
	{ sbbr_acpi_table_check_test2, "Test DSDT and SSDT tables are implemented." },
	{ sbbr_acpi_table_check_test3, "Check for recommended ACPI tables." },
	{ NULL, NULL }
};
